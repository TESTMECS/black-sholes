...
from database.models.calculations import get_calculations, get_calculation_by_id, store_calculation
...
@token_required
def list_calculations(current_user):
...
@token_required
def get_calculation(current_user, calculation_id):
...
def create_calculation(current_user):
    ...
    required_fields = [
        ...
        'volatility', 'risk_free_rate', 'call_price', 'put_price'
    ]
