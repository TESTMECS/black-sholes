...
@token_required
def get_heatmaps(current_user, calculation_id):
...
@token_required
def add_heatmap(current_user, calculation_id):
    """Add a new heatmap to a calculation"""
    data = request.get_json()
    
    required_fields = [
        'heatmap_type', 'min_spot', 'max_spot', 'min_vol', 
        'max_vol', 'spot_steps', 'vol_steps', 'heatmap_data'
    ]
